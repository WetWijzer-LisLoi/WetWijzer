...
class BelgianCourtService
  ...
  JUDICIAL_DISTRICTS = {
    ...
    luxemburg: { area: 'Luik', divisions: %w[Aarlen Marche-en-Famenne Neufchâteau] },
  ...
  FIXED_HOLIDAYS = {
    [1, 1] => { nl: 'Nieuwjaar', fr: 'Nouvel An', de: 'Neujahr' },
    [5, 1] => { nl: 'Dag van de Arbeid', fr: 'Fête du Travail', de: 'Tag der Arbeit' },
    [7, 21] => { nl: 'Nationale Feestdag', fr: 'Fête Nationale', de: 'Nationalfeiertag' },
    [8, 15] => { nl: 'OLV Hemelvaart', fr: 'Assomption', de: 'Mariä Himmelfahrt' },
    [11, 1] => { nl: 'Allerheiligen', fr: 'Toussaint', de: 'Allerheiligen' },
    [11, 11] => { nl: 'Wapenstilstand', fr: 'Armistice', de: 'Waffenstillstand' },
    [12, 25] => { nl: 'Kerstmis', fr: 'Noël', de: 'Weihnachten' }
  }.freeze
  ...
  # Limitation period categories
  LIMITATION_CATEGORIES = {
    civil: { nl: 'Burgerlijk recht', fr: 'Droit civil', de: 'Zivilrecht', name_nl: 'Burgerlijk recht', name_fr: 'Droit civil',
             name_de: 'Zivilrecht' },
    commercial: { nl: 'Handelsrecht', fr: 'Droit commercial', de: 'Handelsrecht', name_nl: 'Handelsrecht', name_fr: 'Droit commercial',
                  name_de: 'Handelsrecht' },
    labor: { nl: 'Arbeidsrecht', fr: 'Droit du travail', de: 'Arbeitsrecht', name_nl: 'Arbeidsrecht', name_fr: 'Droit du travail',
             name_de: 'Arbeitsrecht' },
    administrative: { nl: 'Administratief recht', fr: 'Droit administratif', de: 'Verwaltungsrecht', name_nl: 'Administratief recht',
                      name_fr: 'Droit administratif', name_de: 'Verwaltungsrecht' },
    criminal: { nl: 'Strafrecht', fr: 'Droit pénal', de: 'Strafrecht', name_nl: 'Strafrecht', name_fr: 'Droit pénal',
                name_de: 'Strafrecht' },
    tax: { nl: 'Fiscaal recht', fr: 'Droit fiscal', de: 'Steuerrecht', name_nl: 'Fiscaal recht', name_fr: 'Droit fiscal',
           name_de: 'Steuerrecht' }
  }.freeze

  # Statute of limitations by type
  STATUTE_OF_LIMITATIONS = {
    general_civil: { years: 10, category: :civil, nl: 'Algemene verjaring', fr: 'Prescription générale', de: 'Allgemeine Verjährung',
                     name_nl: 'Algemene verjaring', name_fr: 'Prescription générale', name_de: 'Allgemeine Verjährung' },
    contractual: { years: 10, category: :civil, nl: 'Contractuele vorderingen', fr: 'Actions contractuelles', de: 'Vertragliche Ansprüche',
                   name_nl: 'Contractuele vorderingen', name_fr: 'Actions contractuelles', name_de: 'Vertragliche Ansprüche' },
    tort: { years: 5, category: :civil, nl: 'Buitencontractuele aansprakelijkheid', fr: 'Responsabilité extra-contractuelle',
            de: 'Außervertragliche Haftung', name_nl: 'Buitencontractuele aansprakelijkheid', name_fr: 'Responsabilité extra-contractuelle', name_de: 'Außervertragliche Haftung' },
    personal_injury: { years: 5, category: :civil, nl: 'Lichamelijk letsel', fr: 'Dommages corporels', de: 'Körperverletzung',
                       name_nl: 'Lichamelijk letsel', name_fr: 'Dommages corporels', name_de: 'Körperverletzung' },
    commercial: { years: 10, category: :commercial, nl: 'Handelsvorderingen', fr: 'Actions commerciales', de: 'Handelsansprüche',
                  name_nl: 'Handelsvorderingen', name_fr: 'Actions commerciales', name_de: 'Handelsansprüche' },
    rent: { years: 5, category: :civil, nl: 'Huurvorderingen', fr: 'Actions locatives', de: 'Mietforderungen', name_nl: 'Huurvorderingen',
            name_fr: 'Actions locatives', name_de: 'Mietforderungen' },
    salary: { years: 5, category: :labor, nl: 'Loonvorderingen', fr: 'Actions salariales', de: 'Lohnansprüche', name_nl: 'Loonvorderingen',
              name_fr: 'Actions salariales', name_de: 'Lohnansprüche' },
    labor_general: { years: 1, category: :labor, nl: 'Arbeidsovereenkomst (ontslag)', fr: 'Contrat de travail (licenciement)',
                     de: 'Arbeitsvertrag (Kündigung)', name_nl: 'Arbeidsovereenkomst (ontslag)', name_fr: 'Contrat de travail (licenciement)', name_de: 'Arbeitsvertrag (Kündigung)' },
    tax_claim: { years: 7, category: :tax, nl: 'Belastingvordering', fr: 'Action fiscale', de: 'Steuerforderung',
                 name_nl: 'Belastingvordering', name_fr: 'Action fiscale', name_de: 'Steuerforderung' },
    administrative: { years: 60, category: :administrative, nl: 'Administratief beroep', fr: 'Recours administratif',
                      de: 'Verwaltungsbeschwerde', name_nl: 'Administratief beroep', name_fr: 'Recours administratif', name_de: 'Verwaltungsbeschwerde', days: true },
    criminal_misdemeanor: { years: 1, category: :criminal, nl: 'Overtredingen', fr: 'Contraventions', de: 'Übertretungen',
                            name_nl: 'Overtredingen', name_fr: 'Contraventions', name_de: 'Übertretungen' },
    criminal_delict: { years: 5, category: :criminal, nl: 'Wanbedrijven', fr: 'Délits', de: 'Vergehen', name_nl: 'Wanbedrijven',
                       name_fr: 'Délits', name_de: 'Vergehen' },
    criminal_crime: { years: 10, category: :criminal, nl: 'Misdaden', fr: 'Crimes', de: 'Verbrechen', name_nl: 'Misdaden',
                      name_fr: 'Crimes', name_de: 'Verbrechen' }
  }.freeze

  # Conclusion calendar templates
  CONCLUSION_TEMPLATES = {
    standard: { nl: 'Standaard procedure', fr: 'Procédure standard', de: 'Standardverfahren', name_nl: 'Standaard procedure',
                name_fr: 'Procédure standard', name_de: 'Standardverfahren', default_days: 30 },
    expedited: { nl: 'Verkorte procedure', fr: 'Procédure accélérée', de: 'Beschleunigtes Verfahren', name_nl: 'Verkorte procedure',
                 name_fr: 'Procédure accélérée', name_de: 'Beschleunigtes Verfahren', default_days: 15 },
    summary: { nl: 'Kort geding', fr: 'Référé', de: 'Eilverfahren', name_nl: 'Kort geding', name_fr: 'Référé', name_de: 'Eilverfahren',
               default_days: 8 },
    appeal: { nl: 'Hoger beroep', fr: 'Appel', de: 'Berufung', name_nl: 'Hoger beroep', name_fr: 'Appel', name_de: 'Berufung',
              default_days: 45 }
  }.freeze

  # Court fees (rolrechten) by court and case type
  COURT_FEES = {
    vredegerecht: { rolrecht: 50, expeditie: 1.50, name_nl: 'Vredegerecht', name_fr: 'Justice de paix', name_de: 'Friedensgericht',
                    notes_nl: 'Huur, kleine geschillen ≤ €5.000', notes_fr: 'Bail, petits litiges ≤ 5.000 €', notes_de: 'Miete, kleine Streitigkeiten ≤ 5.000 €' },
    politierechtbank: { rolrecht: 50, expeditie: 1.50, name_nl: 'Politierechtbank', name_fr: 'Tribunal de police', name_de: 'Polizeigericht',
                        notes_nl: 'Verkeerszaken, overtredingen', notes_fr: 'Affaires de roulage, contraventions', notes_de: 'Verkehrsangelegenheiten, Ordnungswidrigkeiten' },
    rechtbank_eerste_aanleg: { rolrecht: 165, expeditie: 2.00, name_nl: 'Rechtbank van Eerste Aanleg', name_fr: 'Tribunal de première instance', name_de: 'Gericht erster Instanz',
                               notes_nl: 'Burgerlijke, straf- en familiezaken', notes_fr: 'Affaires civiles, pénales et familiales', notes_de: 'Zivil-, Straf- und Familienangelegenheiten' },
    arbeidsrechtbank: { rolrecht: 0, expeditie: 0, name_nl: 'Arbeidsrechtbank', name_fr: 'Tribunal du travail', name_de: 'Arbeitsgericht',
                        notes_nl: 'Gratis voor werknemers', notes_fr: 'Gratuit pour les travailleurs', notes_de: 'Kostenlos für Arbeitnehmer' },
    ondernemingsrechtbank: { rolrecht: 200, expeditie: 2.00, name_nl: 'Ondernemingsrechtbank', name_fr: "Tribunal de l'entreprise", name_de: 'Unternehmensgericht',
                             notes_nl: 'Handelsgeschillen, faillissementen', notes_fr: 'Litiges commerciaux, faillites', notes_de: 'Handelsstreitigkeiten, Insolvenzen' },
    hof_van_beroep: { rolrecht: 400, expeditie: 2.50, name_nl: 'Hof van Beroep', name_fr: "Cour d'appel", name_de: 'Berufungsgericht',
                      notes_nl: 'Hoger beroep burgerlijke zaken', notes_fr: 'Appel en matière civile', notes_de: 'Berufung in Zivilsachen' },
    arbeidshof: { rolrecht: 0, expeditie: 0, name_nl: 'Arbeidshof', name_fr: 'Cour du travail', name_de: 'Arbeitsgerichtshof',
                  notes_nl: 'Gratis voor werknemers', notes_fr: 'Gratuit pour les travailleurs', notes_de: 'Kostenlos für Arbeitnehmer' },
    hof_van_cassatie: { rolrecht: 650, expeditie: 3.00, name_nl: 'Hof van Cassatie', name_fr: 'Cour de Cassation', name_de: 'Kassationshof',
                        notes_nl: 'Cassatieberoep', notes_fr: 'Pourvoi en cassation', notes_de: 'Kassationsbeschwerde' }
  }.freeze

  # Document checklists by procedure type
  DOCUMENT_CHECKLISTS = {
    divorce: {
      nl: 'Echtscheiding',
      fr: 'Divorce',
      documents: [
        { nl: 'Huwelijksakte', fr: 'Acte de mariage', required: true },
        { nl: 'Geboorteaktes kinderen', fr: 'Actes de naissance des enfants', required: true },
        { nl: 'Bewijs woonplaats', fr: 'Preuve de domicile', required: true },
        { nl: 'Inkomensbewijzen', fr: 'Preuves de revenus', required: true },
        { nl: 'Eigendomsbewijzen', fr: 'Titres de propriété', required: false }
      ]
    },
    labor_claim: {
      nl: 'Arbeidsvordering',
      fr: 'Action en matière de travail',
      documents: [
        { nl: 'Arbeidsovereenkomst', fr: 'Contrat de travail', required: true },
        { nl: 'Loonfiches', fr: 'Fiches de paie', required: true },
        { nl: 'Ontslagbrief', fr: 'Lettre de licenciement', required: true },
        { nl: 'C4 formulier', fr: 'Formulaire C4', required: true },
        { nl: 'Correspondentie', fr: 'Correspondance', required: false }
      ]
    },
    civil_claim: {
      nl: 'Burgerlijke vordering',
      fr: 'Action civile',
      documents: [
        { nl: 'Contract/overeenkomst', fr: 'Contrat/accord', required: true },
        { nl: 'Facturen', fr: 'Factures', required: true },
        { nl: 'Ingebrekestellingen', fr: 'Mises en demeure', required: true },
        { nl: 'Betalingsbewijzen', fr: 'Preuves de paiement', required: false },
        { nl: 'Correspondentie', fr: 'Correspondance', required: false }
      ]
    },
    bankruptcy: {
      ...
      fr: 'Faillite',
      documents: [
        { nl: 'Jaarrekeningen (3 jaar)', fr: 'Comptes annuels (3 ans)', required: true },
        { nl: 'Schuldenlijst', fr: 'Liste des dettes', required: true },
        { nl: 'Personeelslijst', fr: 'Liste du personnel', required: true },
        { nl: 'Activa-inventaris', fr: 'Inventaire des actifs', required: true },
  ...
  class << self
    ...
    # Get all judicial districts with their info
    def judicial_districts
      JUDICIAL_DISTRICTS.transform_values do |info|
        {
          name_nl: info[:area],
          name_fr: info[:area], # Same name in FR
          divisions: info[:divisions],
          bilingual: info[:bilingual] || false,
    ...
    def expand_query_with_synonyms(query)
      ...
      LEGAL_TERMINOLOGY.each do |nl_term, translations|
        expanded.concat(translations) if terms.include?(nl_term) || terms.any? { |t| nl_term.include?(t) }
    ...
    def grouped_courts_for_select(locale = :nl)
      {
        level_label(1, locale) => courts_at_level(1).map { |k, v| [locale == :nl ? v[:name_nl] : v[:name_fr], k] },
        level_label(2, locale) => courts_at_level(2).map { |k, v| [locale == :nl ? v[:name_nl] : v[:name_fr], k] },
        level_label(3, locale) => courts_at_level(3).map { |k, v| [locale == :nl ? v[:name_nl] : v[:name_fr], k] },
        level_label(4, locale) => courts_at_level(4).map { |k, v| [locale == :nl ? v[:name_nl] : v[:name_fr], k] }
      }
    end
    ...
    def public_holidays(year)
      ...
      holidays[easter] = { nl: 'Pasen', fr: 'Pâques', de: 'Ostern' }
      holidays[easter + 1] = { nl: 'Paasmaandag', fr: 'Lundi de Pâques', de: 'Ostermontag' }
      holidays[easter + 39] = { nl: 'Hemelvaart', fr: 'Ascension', de: 'Christi Himmelfahrt' }
      holidays[easter + 49] = { nl: 'Pinksteren', fr: 'Pentecôte', de: 'Pfingsten' }
      holidays[easter + 50] = { nl: 'Pinkstermaandag', fr: 'Lundi de Pentecôte', de: 'Pfingstmontag' }
    ...
    def during_judicial_vacation?(date)
      ...
      d.between?(vacation_start, vacation_end)
    end
    ...
    def calculate_deadline(service_date, deadline_days, apply_vacation_rule: true)
      ...
      (start_date..raw_deadline).each do |d|
        result[:holidays_in_period] << { date: d, name: holiday_name(d) } if public_holiday?(d)
      end
    ...
    def courts_for_deadline_calculator(locale = :nl)
      COURTS.map do |key, info|
        ...
        {
          key: key,
          name: locale == :nl ? info[:name_nl] : info[:name_fr],
          deadline_days: info[:appeal_deadline_days],
          appeal_to: if info[:appeal_to]
                       locale == :nl ? COURTS[info[:appeal_to]][:name_nl] : COURTS[info[:appeal_to]][:name_fr]
                     end
        }
      end.compact
    end
    ...
    LAW_COURT_MAPPINGS = {
      ...
      labor: {
        ...
        courts: %i[arbeidsrechtbank arbeidshof]
      },
      ...
      commercial: {
        ...
        courts: %i[ondernemingsrechtbank hof_van_beroep]
      },
      ...
      criminal: {
        ...
        courts: %i[rechtbank_eerste_aanleg hof_van_beroep hof_van_assisen]
      },
      # Tax law -> Various
      tax: {
        patterns: [
        ...
        courts: %i[rechtbank_eerste_aanleg hof_van_beroep]
      },
    ...
    def find_competent_court(case_type:, amount: nil, district: nil)
      ...
      when 'criminal_major'
        ...
        notes = case I18n.locale when :fr then 'La qualification exacte détermine le tribunal compétent.' when :de then 'Die genaue Qualifizierung bestimmt das zuständige Gericht.' when :en then 'The exact qualification determines the competent court.' else 'De exacte kwalificatie bepaalt de bevoegde rechtbank.' end
      when 'administrative'
    ...
    STATUTE_OF_LIMITATIONS = {
      ...
      tort: { years: 5, name_nl: 'Onrechtmatige daad', name_fr: 'Responsabilité extracontractuelle', basis: 'Art. 2262bis §1, 2° BW',
              category: 'civil' },
      tort_personal: { years: 20, name_nl: 'Lichamelijke schade', name_fr: 'Dommages corporels', basis: 'Art. 2262bis §1, 2° BW',
                       category: 'civil' },
      periodic: { years: 5, name_nl: 'Periodieke betalingen', name_fr: 'Paiements périodiques', basis: 'Art. 2277 BW', category: 'civil' },

      # Commercial
      commercial: { years: 10, name_nl: 'Handelszaken', name_fr: 'Affaires commerciales', basis: 'Art. 2262bis BW',
                    category: 'commercial' },
      ...
      construction: { years: 10, name_nl: 'Bouwgebreken', name_fr: 'Vices de construction', basis: 'Art. 1792, 2270 BW',
                      category: 'commercial' },

      # Labor
      labor: { years: 5, name_nl: 'Arbeidsovereenkomst', name_fr: 'Contrat de travail', basis: 'Art. 15 AOW', category: 'labor' },
      labor_accident: { years: 3, name_nl: 'Arbeidsongeval', name_fr: 'Accident du travail', basis: 'Art. 69 Arbeidsongevallenwet',
                        category: 'labor' },
      social_security: { years: 3, name_nl: 'Sociale zekerheid', name_fr: 'Sécurité sociale', basis: 'Art. 174 RSZ-wet',
                         category: 'labor' },
      ...
      tax_registration: { years: 10, name_nl: 'Registratierechten', name_fr: 'Droits d\'enregistrement', basis: 'Art. 214 W.Reg.',
                          category: 'tax' },
      tax_inheritance: { years: 10, name_nl: 'Successierechten', name_fr: 'Droits de succession', basis: 'Art. 137 W.Succ.',
                         category: 'tax' },
      ...
      criminal_serious: { years: 15, name_nl: 'Misdaad (niet-gecorr.)', name_fr: 'Crime (non-corr.)', basis: 'Art. 21 Sv.',
                          category: 'criminal' },
      criminal_sexual: { years: 15, name_nl: 'Seksuele misdrijven', name_fr: 'Infractions sexuelles', basis: 'Art. 21bis Sv.',
                         category: 'criminal' },

      # Insurance
      insurance: { years: 3, name_nl: 'Verzekering', name_fr: 'Assurance', basis: 'Art. 88 Verzekeringswet', category: 'insurance' },
      insurance_life: { years: 30, name_nl: 'Levensverzekering', name_fr: 'Assurance vie', basis: 'Art. 88 Verzekeringswet',
                        category: 'insurance' },
      ...
      # Administrative
      admin_damage: { years: 5, name_nl: 'Schade door overheid', name_fr: 'Dommages par l\'État', basis: 'Art. 100 RvS-wet',
                      category: 'administrative' },
      urban: { years: 5, name_nl: 'Stedenbouwmisdrijf', name_fr: 'Infraction urbanistique', basis: 'Art. 6.1.1 VCRO',
               category: 'administrative' },

      # Family
      alimony: { years: 5, name_nl: 'Onderhoudsgeld', name_fr: 'Pension alimentaire', basis: 'Art. 2277 BW', category: 'family' },
      inheritance: { years: 30, name_nl: 'Erfenis (inkorting)', name_fr: 'Succession (réduction)', basis: 'Art. 921 BW',
                     category: 'family' },

      # Medical
      medical: { years: 20, name_nl: 'Medische fout', name_fr: 'Faute médicale', basis: 'Art. 2262bis §1, 2° BW', category: 'medical' },
      product_liability: { years: 10, name_nl: 'Productaansprakelijkheid', name_fr: 'Responsabilité du fait des produits',
                           basis: 'Art. 12 Productaansprakelijkheidswet', category: 'medical' }
    }.freeze
