...
module LawSearchConstants
  ...
  TYPE_MAPPING = {
    ...
    de: {
      # Compatibility mapping while language_id=3 is reserved but dormant.
      # German UI/search falls back to the canonical French source corpus.
      constitution: '6',
      law: '7',          # Gesetz
      decree: '8',       # Dekret
      ordinance: '9',    # Verordnung
      decision: '10',    # Erlass
      misc: '11'
    }.freeze
  }.freeze
