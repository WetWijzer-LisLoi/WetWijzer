...
module Search
  ...
  class ArticleLookupService
    ...
    LAW_ABBREVIATIONS = {
      ...
      'ger.w' => %w[1967101052 1967101053 1967101054 1967101055 1967101056 1967101057 1967101063 1967101064],
      'ger.w.' => %w[1967101052 1967101053 1967101054 1967101055 1967101056 1967101057 1967101063 1967101064],
      'gerw' => %w[1967101052 1967101053 1967101054 1967101055 1967101056 1967101057 1967101063 1967101064],
      'cj' => %w[1967101052 1967101053 1967101054 1967101055 1967101056 1967101057 1967101063 1967101064],
    ...
    def initialize(locale: :nl)
      @language_id = %w[fr de].include?(locale.to_s) ? 2 : 1
    end
    ...
    def article_url(article)
      anchor = extract_article_anchor(article.article_title) || "#art-#{article.id}"
      "/laws/#{article.content_numac}?language_id=#{@language_id}#{anchor}"
    end
  end
end
