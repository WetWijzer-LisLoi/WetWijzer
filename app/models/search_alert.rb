...
#     frequency: 'daily'
#   )
class SearchAlert < AccountRecord
  # Validations
  ...
  # Encrypt PII at rest (GDPR - email is PII, search queries reveal legal interests)
  encrypts :email, deterministic: true  # deterministic: allows uniqueness checks
  encrypts :query, deterministic: true  # deterministic: allows uniqueness scope with email
  ...
  scope :due_for_notification, lambda { |frequency|
