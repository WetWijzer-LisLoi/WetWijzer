...
module ReferencesHelper
  include References::AbolishedRendering
    ...
    content_tag(:h2, id: heading_id,
      ...
      collapse_button = content_tag(:button, type: 'button',
        ...
        chevron = content_tag(:svg, xmlns: 'http://www.w3.org/2000/svg',
                                    class: 'w-5 h-5 shrink-0 transition-transform text-gray-500 dark:text-gray-400',
                                    viewBox: '0 0 20 20',
                                    fill: 'currentColor',
...
"
  ...
  # ============================================================================
  # SECTION 3: ABOLISHED CONTENT RENDERING (lines ~1018-1345)
  # → Extracted to References::AbolishedRendering
