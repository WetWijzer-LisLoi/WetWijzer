...
module ArticleReferencesHelper
  # The article_exdec_mapping cache key carries CacheVersionHelper's
  # render_code_version, a digest of this file among others, so a change to
  # the extraction rules below invalidates stored mappings on the next deploy
  # without anyone having to bump a literal.
