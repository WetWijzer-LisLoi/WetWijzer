...
export default class extends Controller {
  ...
  connect() {
    ...
    // Set up auto-show on desktop when the Tekst section is in view (md ≥ 768px)
    this.desktopMedia = window.matchMedia && window.matchMedia("(min-width: 768px)");
...
updateExpandedFixedPosition() {
  try {
    ...
    // Overlay mode: ensure content is not offset
