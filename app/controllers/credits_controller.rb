...
class CreditsController < ApplicationController
  ...
  def index
    ...
    @current_credits = current_user.credits # purchased (permanent)
    @weekly_credits = current_user.weekly_credits_remaining
    @pro_credits = current_user.pro_credits_remaining
